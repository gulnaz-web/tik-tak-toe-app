      ...
      >
        <button
          ...
          className="
            ...
            absolute top-0 left-[calc(100%+12px)] cursor-pointer"
        >
...
Modal.Header = function UiModalHeader({
  children,
  className,
...
Modal.Body = function UiModalBody({
  children,
  className,
}: ModalSubComponentProps) {
...
Modal.Footer = function UiModalFooter({
  children,
  className,
}: ModalSubComponentProps) {
  return (
...
type CrossLightIconProps = {
  className?: string;
};

function CrossLightIcon({ className }: CrossLightIconProps) {
  return (
    <svg
      className={className}
      width="16"
